...
export default function CTASection({ locale }: CTASectionProps) {
  ...
  return (
    <section
      className="py-20 bg-[#2a2a2a] md:bg-white relative overflow-hidden"
      dir={isRTL ? 'rtl' : 'ltr'}
    >
      <div className="w-full max-w-[1200px] h-auto lg:h-[554px] shrink-0 relative z-[265] mx-auto px-4 flex justify-center items-center flex-col lg:flex-row gap-5 lg:gap-0">
        ...
        <motion.div
          ...
          className="block w-[50%] lg:w-[261px] h-[300px] lg:h-[554px] bg-[url('/assets/f2.svg')] bg-contain lg:bg-cover bg-no-repeat md:absolute top-0 left-[225px] z-[274]"
        />

        {/* 🔹 Background box (no animation) */}
        ...
        <motion.div
          ...
          viewport={{ once: false, amount: 0.3 }}
          className="relative z-[267] lg:mt-[200px] lg:absolute lg:top-0 lg:left-[624px] flex flex-col items-center lg:items-start gap-10 w-full lg:w-[372px] px-2 lg:px-0"
        >
          {/* Texts */}
